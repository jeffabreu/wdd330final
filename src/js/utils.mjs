...
document.addEventListener('DOMContentLoaded', () => {
  // Fetch the JSON data
  fetch('json/popular.json') // Replace 'your-json-file.json' with the actual path to your JSON file
    .then(response => response.json())
    .then(data => {
      // Process the data and update the carousel
      const recipeCarouselElement = document.getElementById('recipeCarousel');
